...
public class ClientInventoryStatisticsVo {
	...
	private String airBottleBelongName;

	private Integer count;

	public ClientInventoryStatisticsVo(){
		
	}
	
	public ClientInventoryStatisticsVo(Integer clientId, String secondCategoryName, String clientCode, String clientName, String clientTypeName,
			...
			String airBottleTypeName, String airBottleBelongName, Long count) {
		...
		this.airBottleBelongName = airBottleBelongName;
	...
	public String getAirBottleBelongName() {
		return airBottleBelongName;
	}

	public void setAirBottleBelongName(String airBottleBelongName) {
		this.airBottleBelongName = airBottleBelongName;
	}
