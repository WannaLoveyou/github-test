...
public class SZHandOverDataVo {
	...
	// 对象属性初始化值为接口要求的空值字符串
	{
		...
		this.handOverName = SZPublicServiceUtil.NULL_VALUE_STR;
		this.handOverDate = SZPublicServiceUtil.NULL_VALUE_STR;
		this.userName = SZPublicServiceUtil.NULL_VALUE_STR;
		this.userCardNo = SZPublicServiceUtil.NULL_VALUE_STR;
	}

	public SZHandOverDataVo() {

	}
	
	public SZHandOverDataVo(AirBottleTrackingRecord r ) {
	 ...
	 * @param supplyDate
	 */
	public SZHandOverDataVo(String enterpriseSteelNo, String bottleLabelNo, Integer standard, String handOverName,
