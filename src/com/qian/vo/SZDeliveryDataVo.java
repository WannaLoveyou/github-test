...
public class SZDeliveryDataVo {
	...
	// 对象属性初始化值为接口要求的空值字符串
	{
		...
		this.deliveryName = SZPublicServiceUtil.NULL_VALUE_STR;
		this.deliveryDate = SZPublicServiceUtil.NULL_VALUE_STR;
		this.stationName = SZPublicServiceUtil.NULL_VALUE_STR;
	}

	public SZDeliveryDataVo() {

	}
	
	public SZDeliveryDataVo(AirBottleTrackingRecord r ) {
	 ...
	 * @param supplyDate
	 */
	public SZDeliveryDataVo(String enterpriseSteelNo, String bottleLabelNo, Integer standard, String deliveryName,
