...
@Component
@Lazy(false)
public class DGPublicServiceController {
...
//	@Scheduled(cron = "0 0/1 * * * ? ")
	...
	public void uploadFillingData() {
		// 判断是否开启数据上传
		ModuleConfigurationInfo moduleConfigurationInfo = moduleConfigurationInfoService.findById(ModuleConfigurationCode.DG_PUBLIC_SERVICE_PLATFORM);
