...
function initOrderDialog(orderInfoRow){
	...
	document.getElementById('print_pay_type').innerHTML = orderInfoRow.pay_type_name;
	...
	document.getElementById('print_price').innerHTML = (orderInfoRow.price + orderInfoRow.delivery_fee + orderInfoRow.floor_subsidies_money).toFixed(2);
	document.getElementById('print_count').innerHTML = orderInfoRow.order_number;
	document.getElementById('print_total_price').innerHTML = ((orderInfoRow.price + orderInfoRow.delivery_fee + orderInfoRow.floor_subsidies_money) * orderInfoRow.order_number).toFixed(2);
