...
function outToFile() {
	...
	document.getElementById("toolbarForm").action = basePath
			+ '/saleReport/exportSaleDetailReportInfo';
			...
			.datagrid(
					{
						...
						url : basePath + '/saleReport/getSaleDetailReportInfo',
						...
						columns : [ [ {
							...
							field : 'warehouseOrderBottleNumber',
							title : '进货瓶数',
							align : 'center',
							width : 100,
							sortable : true
							...
							$('#reportTable')
									.datagrid(
											...
											[ {
												...
												warehouseOrderBottleNumber : footers.warehouseOrderBottleNumber,
