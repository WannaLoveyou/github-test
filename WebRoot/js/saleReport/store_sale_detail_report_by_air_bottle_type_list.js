...
function outToFile() {
	...
	document.getElementById("toolbarForm").action = basePath + '/saleReport/exportSaleDetailReportInfoByAirBottleTypeInfo';  
			...
			.datagrid(
					{
						...
						url : basePath + '/saleReport/getSaleDetailReportInfoByAirBottleTypeInfo',
