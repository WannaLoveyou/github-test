...
function initDatagrid(){
	 ...
	 $('#tb').datagrid({
         ...
         columns:[[
             ...
             {field:'production_unit_code',title:'生产单位编号',align:'center',width:100},
             {field:'production_unit_name',title:'生产单位名称',align:'center',width:100},
         ]],
...
function initEdit(){
    ...
    $("#myform").form("load",{
        ...
        production_unit_name:selectRows[0].production_unit_name,
    });
