...
<body>
		...
		<center>
			<form id="myform" action="">
				...
				<table>
					<tr>
						<td>投诉类型名：</td>
						<td><input id="complaint_type_name"
							name="complaint_type_name" required="true" />
						</td>
					</tr>
					<tr>
						<td>投诉内容描述：</td>
						<td colspan="6"><textarea style="height:100px;width: 300px;"
								id="complaint_content" name="complaint_content" required="true"></textarea>
						</td>
					</tr>
	...
	<script type="text/javascript"
		src="${contextPath}/js/complaintType/list.js"></script>
</body>
</html>