...
<body id="homeLayout" class="easyui-layout">
	<div data-options="region:'center',title:''"
		...
		<table id="warehouseInventoryTable" class="easyui-datagrid"
		...
		<form id="toolbarForm" method="post">
			<table>
				<tr>
					...
					<td>所属仓库：</td>
					<td><input id="warehouseInfoTool" name="warehouseInfo.id"
	...
	<script type="text/javascript"
		src="${contextPath}/js/warehouse/warehouse_inventory_info_list.js"></script>
</body>
