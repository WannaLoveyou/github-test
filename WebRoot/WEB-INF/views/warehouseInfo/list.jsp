...
<body>
		...
		<center>
			<form id="myform" action="">
				...
				<table>
					<tr>
						<td>仓库编码：</td>
						<td><input id="warehouse_code" name="warehouse_code"
							required="true" /></td>
					</tr>
					<tr>
						<td>仓库名：</td>
						<td><input id="warehouse_name" name="warehouse_name"
							required="true" /></td>
					</tr>
					<tr>
						<td>充装站点编号：</td>
						<td><input id="filling_station_id" name="filling_station_id"
							required="true" /></td>
					</tr>
	...
	<script type="text/javascript"
		src="${contextPath}/js/warehouseInfo/list.js"></script>
</body>
</html>