...
<body>
		...
		<center>
			<form id="myform" action="">
				...
				<table>
					<tr>
						<td>检测单位编号：</td>
						<td><input id="detection_unit_code" name="detection_unit_code" required="true" />
						</td>
					</tr>
					<tr>
						<td>检测单位名称：</td>
						<td><input id="detection_unit_name" name="detection_unit_name" required="true" />
						</td>
					</tr>
	...
	<script type="text/javascript"
		src="${contextPath}/js/detectionUnit/list.js"></script>
</body>
</html>