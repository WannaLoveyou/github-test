...
<body>
		...
		<center>
			<form id="myform" action="">
				...
				<table>
					<tr>
						<td>投诉类型名：</td>
						<td><input id="visit_type_name"
							name="visit_type_name" required="true" />
						</td>
					</tr>
					<tr>
						<td>投诉内容描述：</td>
						<td colspan="6"><textarea style="height:100px;width: 300px;"
								id="visit_content" name="visit_content" required="true"></textarea>
						</td>
					</tr>
	...
	<script type="text/javascript"
		src="${contextPath}/js/visitType/list.js"></script>
</body>
</html>