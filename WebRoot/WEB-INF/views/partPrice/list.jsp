...
<body>
   ...
   <center>
    ...
    <tr>
    <td>零件类型：</td>
    <td><input  id="partType" name="partType.id" class="easyui-combobox" editable="false" required="true"/></td>
    </tr>
    <tr>
    <td>气瓶类型：</td>
    <td><input id="airBottleType" name="airBottleType.id" class="easyui-combobox" editable="false" required="true"/></td>
    </tr>
    <tr>
    <td>零件单价：</td>
    ...
    <script type="text/javascript"
		src="${contextPath}/js/partPrice/list.js"></script>
</body>
</html>