...
<div id="printDisplayDialog" class="easyui-dialog" title=" "
	...
	<div id="print_div" class="print_div">
		<table cellpadding="0" cellspacing="0" align="left">
			<tr>
				<td align="center"
					style="width: 1.71cm; font-size: 14px; height: 0.7cm; color: #ffffff;"  class="sc-name">电脑序号</td>
				...
				<td align="center"
					style="width: 1.6cm; font-size: 14px; color: #333333;">时间</td>
				<td id="print_now_time" align="left"
					style="width: 3.5cm; font-size: 14px; padding-left: 15px;"></td>
			</tr>
			<tr>
				<td align="center"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">客户名称</td>
				<td id="print_client_name" align="left" colspan="2"
					style="font-size: 14px; padding-left: 5px;"></td>
				<td align="center" colspan="2"
					style="font-size: 14px; color: #ffffff;">客户编号</td>
				<td id="print_client_code" align="left"
					style="font-size: 14px; padding-left: 5px;"></td>
				<td align="center" style="font-size: 14px; color: #ffffff;">结款方式</td>
				<td id="print_pay_type" align="left"
					style="font-size: 14px; padding-left: 5px;">现结</td>
			</tr>
			<tr>
				<td align="center"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">客户电话</td>
				<td id="print_client_tel_number" align="left" colspan="5"
					style="font-size: 14px; padding-left: 5px;"></td>
				<td align="center" style="font-size: 14px; color: #ffffff;">安检提示</td>
				<td id="print_security_info" align="left"
					style="font-size: 14px; padding-left: 5px;">已安检</td>
			</tr>
			<tr>
				<td align="center"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">客户地址</td>
				<td id="print_order_address" align="left" colspan="5"
					style="font-size: 14px; padding-left: 5px;"></td>
				<td align="center" style="font-size: 14px; color: #ffffff;">备注</td>
				<td id="print_remark" align="left"
					style="font-size: 14px; padding-left: 5px;"></td>
			</tr>
			<tr>
				<td align="center" colspan="2"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">商品(业务)名称</td>
				<td align="center" style="font-size: 14px; color: #ffffff;">规格型号</td>
				<td align="center" style="font-size: 14px; color: #ffffff;">数量</td>
				<td align="center" style="font-size: 14px; color: #ffffff;">单价</td>
				<td align="center" style="font-size: 14px; color: #ffffff;">金额</td>
				<td align="center" style="font-size: 14px; color: #ffffff;">配送部门</td>
				<td id="print_deliver_department" align="left"
					style="font-size: 14px; padding-left: 5px;"></td>
			</tr>
			<tr>
				<td id="print_business_deposit" align="center" colspan="2"
				...
				<td id="print_total_price" align="center"
					style="font-size: 14px;"></td>
				<td align="center" style="font-size: 14px; color: #ffffff;">制单人员</td>
			...
			<tr id="printOrderInfoRowsTr1">
				...
				<td align="center"
					style="font-size: 14px;"></td>
				<td align="center" style="font-size: 14px; color: #ffffff;">运送人员</td>
			...
			<tr id="printOrderInfoRowsTr2">
				...
				<td align="center" rowspan="2"
					style="font-size: 14px; color: #ffffff;">客户确认</td>
				<td align="left" style="font-size: 14px; color: #333333;">（单价已含送气费）</td>
			</tr>
			<tr>
				<td align="center"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">合计：</td>
			...
			<tr>
				<td align="center"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">本次重瓶</td>
				<td id="print_this_time_heavy_bottle" align="left" colspan="7"
					style="font-size: 14px;"></td>
			</tr>
			<tr>
				<td align="center"
					style="font-size: 14px; height: 0.7cm; color: #ffffff;">应回空瓶</td>
