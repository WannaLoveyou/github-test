...
<body id="homeLayout" class="easyui-layout">
	<div data-options="region:'center',title:''"
		...
		<div id="reportTableId">
			<table id="reportTable" class="easyui-datagrid" toolbar="#toolbar"
				...
				data-options="fitColumns:true,nowrap:false,rownumbers:true,striped:true,pagination:true,pageSize:50,pageList:[10,20,50,100]">
				<thead>
					<tr>
	...
	<script type="text/javascript"
		src="${contextPath}/js/gaoNengShow/before_check_list.js"></script>
</body>
