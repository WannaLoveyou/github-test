	...
	<script type="text/javascript">
		...
		function initClientCoordinates(){
			...
			$.ajax({
				...
				url:basePath+'/showReport/getClientCoordinates',
		...
		function initMapPoints(list){		
			...
			for (var i = 0; i < list.length; i++) {
				...
				marker.content = "<div style='font-size:15px;'>" + 
					"钢瓶码：" + list[i].airBottleSealCode + 
					"</br>客户名：" + list[i].clientName + 
					"</br>客户编号：" + list[i].clientCode + 
					"</br>客户地址：" + list[i].clientAddress + 
					"</br>配送时间：" + list[i].createTime + 
					"</div>";
