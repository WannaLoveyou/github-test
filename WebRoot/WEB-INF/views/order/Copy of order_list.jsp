...
<body>
	...
	<div class="easyui-panel" iconCls="icon-search" collapsible="true"
							...
							<form id="clientInfoForm" action="">
								<table>
									<tr>
										...
										<td>电话号码：</td>
										<td><input id="mobile" name="mobile" style="width:100px" />
					...
					<div region="east" split="true" border="true"
						...
						<div class="easyui-layout" fit="true">
							<div id="tt-tabs" class="easyui-tabs"
								...
								<!-- 
							<div title="回访受理" iconCls="icon-reload" style="padding:10px;">
								Second Tab</div>
