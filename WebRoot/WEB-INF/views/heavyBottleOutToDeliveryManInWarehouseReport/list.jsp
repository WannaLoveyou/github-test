...
<body id="homeLayout" class="easyui-layout">
	...
	<div id="toolbar">
		<form id="toolbarForm" method="post">
			<table>
				...
				<tr>
				<td>所属门店：</td>
				<td><input id="secondCategoryToolId" name="deliveryManSecondCategory.id"
					editable="false" class="easyui-combobox" /></td>
				<td>对应配送工：</td>
					<td><input id="deliveryManToolId" name="deliveryMan.id"
				...
				<td><input id="airBottleTypeToolId" name="airBottleType.id"
					editable="false" class="easyui-combobox" /></td>
				<td>配送工姓名：</td>
				<td><input id="delivery_man" name="delivery_man" /></td>
	...
	<script type="text/javascript"
		src="${contextPath}/js/heavyBottleOutToDeliveryManInWarehouseReport/list.js"></script>
</body>
