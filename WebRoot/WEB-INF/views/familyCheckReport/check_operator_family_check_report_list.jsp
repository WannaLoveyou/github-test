...
<body id="homeLayout" class="easyui-layout">
	...
	<div id="toolbar">
		<form id="toolbarForm" method="post">
			<table>
				<tr>
					<td>所属门店：</td>
					<td><input id="secondCategoryToolId" name="checkOperatorSecondCategory.id"
						editable="false" class="easyui-combobox" /></td>
					<td>安检开始日期：</td>
					<td><input id="family_check_time_begin_time" name="family_check_time_begin_time"
						class="easyui-datebox" editable="false" /></td>
					<td>安检结束日期：</td>
					<td><input id="family_check_time_end_time" name="family_check_time_end_time"
						class="easyui-datebox" editable="false" /></td>
	...
	<script type="text/javascript"
		src="${contextPath}/js/familyCheckReport/check_operator_family_check_report_list.js"></script>
</body>
